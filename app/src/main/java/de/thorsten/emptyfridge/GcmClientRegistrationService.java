 ...
 */
public class GcmClientRegistrationService {

    private GcmClient gcmClient;

    public GcmClientRegistrationService(GcmClient gcmClient) {
        this.gcmClient = gcmClient;
    }



    public static String POST(String url, GcmClient gcmClient){
        ...
        try {
            ...
            jsonObject.accumulate("regId", gcmClient.getRegId());
